...
import { App, TerraformStack, TerraformOutput, AssetType, TerraformAsset } from "cdktf";
...
class LambdaStack extends TerraformStack {
  constructor(scope: Construct, name: string, config: LambdaFunctionConfig) {
    ...
    const lambdaFunc = new aws.lambdaFunction.LambdaFunction(this, "hello-world-lambda", {
